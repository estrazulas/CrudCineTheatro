...
{  
	...
	private List<String> atributosNomes;
	
	public List<String> getAtributosNomes() {
		return atributosNomes;
	}

	public void setAtributosNomes(List<String> atributosNomes) {
		this.atributosNomes = atributosNomes;
	}
	...
	public DataTables(List<T> t, long iTotalRecords, long iTotalDisplayRecords, String sSearch, String sEcho, List<String> atributosNomes) 
	{
		this.atributosNomes=atributosNomes;
