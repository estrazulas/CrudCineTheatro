 ...
 */
function isCpfCnpj(campoid)
{
	var pCpfCnpj = document.getElementById(campoid).value;
	var numero = pCpfCnpj.replace(/\D/g, "");
	if (numero.length > NUM_DIGITOS_CPF) {
		var cnpjok = isCnpj(pCpfCnpj);
		mostraErroCond("CPF/CNPJ Inválido",campoid,cnpjok);
		return cnpjok;
	}
	else {
		var cpfok = isCpf(pCpfCnpj);
		mostraErroCond("CPF/CNPJ Inválido",campoid,cpfok);
		return cpfok
	}
} //isCpfCnpj
